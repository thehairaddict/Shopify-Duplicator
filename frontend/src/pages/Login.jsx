      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-cyber-darker rounded-2xl shadow-xl dark:shadow-cyber-cyan/20 p-8 border dark:border-cyber-cyan/30">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center space-x-2">
            <LogIn className="dark:text-cyber-cyan" />
            <span>Login</span>
          </h2>
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/register" className="text-blue-600 dark:text-cyber-cyan hover:underline font-medium">
              Register
            </Link>
          </p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-gray-500 dark:text-gray-500">
          Demo: admin@zenithweave.com / admin123
        </p>
      </div>
    </div>
  );
